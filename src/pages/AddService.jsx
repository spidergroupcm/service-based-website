...
import { FaImage, FaPen, FaDollarSign, FaMapMarkerAlt } from 'react-icons/fa';
...
const AddService = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-700 via-purple-400 to-blue-600 p-3">
      <form
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                name="photo"
                required
                className="input input-bordered w-full mt-2 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 pl-10"
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <FaPen className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500" />
            </div>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="relative">
              <select
                name="serviceArea"
                required
                className="select select-bordered w-full mt-2 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 pl-10"
              >
        ...
        <div>
          ...
          <div className="relative">
            <textarea
              name="description"
              required
              className="textarea textarea-bordered w-full mt-2 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 pl-10"
